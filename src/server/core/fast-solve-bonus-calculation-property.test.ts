...
import { FastSolveBonusSystem, type FastSolveBonusConfig } from '../../shared/fast-solve-bonus-system';
    ...
    await fc.assert(
      fc.property(
        ...
        ({ solveTime, baseScore, thresholdSeconds }) => {
          const system = new FastSolveBonusSystem({ thresholdSeconds });
          ...
          const defaultSystem = new FastSolveBonusSystem();
    ...
    await fc.assert(
      fc.property(
        ...
        ({ baseScore, difficulty, bonusPercentage }) => {
          const system = new FastSolveBonusSystem({ bonusPercentage });
    ...
    await fc.assert(
      fc.property(
        ...
        ({ thresholdSeconds, bonusPercentage, difficultyScaling, difficulty }) => {
          ...
          const system = new FastSolveBonusSystem(config);
