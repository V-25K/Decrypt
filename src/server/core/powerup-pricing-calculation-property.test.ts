...
import { PowerupPricingEngine, type PowerupPricingConfig } from '../../shared/powerup-pricing-engine';
    ...
    await fc.assert(
      fc.property(
        ...
        ({ difficulty, remainingLetters, rocketMultiplier }) => {
          const engine = new PowerupPricingEngine({
          ...
          const defaultEngine = new PowerupPricingEngine();
    ...
    await fc.assert(
      fc.property(
        ...
        ({ rocketMultiplier, baseLettersPerCoin, difficulty, remainingLetters }) => {
          ...
          const engine = new PowerupPricingEngine(config);
