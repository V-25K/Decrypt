...
describe('RebalancedRetryCostCalculator', () => {
  let calculator: RebalancedRetryCostCalculator;

  beforeEach(() => {
    calculator = new RebalancedRetryCostCalculator();
  });
  ...
  describe('constructor', () => {
    ...
    it('should allow custom configuration', () => {
      ...
      const customCalculator = new RebalancedRetryCostCalculator(customConfig);
