...
/**
 * RebalancedFastSolveBonusSystem implements the new fast solve bonus system
 ...
 */
export class RebalancedFastSolveBonusSystem {
...
/**
 * Singleton instance of the rebalanced fast solve bonus system
 */
export const rebalancedFastSolveBonusSystem = new RebalancedFastSolveBonusSystem();