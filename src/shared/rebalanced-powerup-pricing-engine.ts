...
/**
 * RebalancedPowerupPricingEngine implements the new powerup pricing system
 ...
 */
export class RebalancedPowerupPricingEngine {
...
/**
 * Singleton instance of the rebalanced powerup pricing engine
 */
export const rebalancedPowerupPricingEngine = new RebalancedPowerupPricingEngine();
