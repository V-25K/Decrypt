...
export type DailyLeaderboardEntry = RouterOutputs['leaderboard']['getDaily']['entries'][number];
export type AllTimeLeaderboardEntry = RouterOutputs['leaderboard']['getAllTime']['levels'][number];
...
export type AppScreen = 'challenge' | 'home' | 'shop' | 'quest' | 'stats' | 'leaderboard';
